...
namespace ЛР7
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            //People p1 = new People("Василий",16);
            //People p2 = new People("Петя", 14);
            //MessageBox.Show(p1.CompareTo(p2).ToString());

            //People[] people = new People[] { p1, p2};
            //Array.Sort(people, new PeopleComparer());
            //foreach (People p in people)
            //{
            //    MessageBox.Show("Имя: " + p.name + "\rБаланс:" + p.money);
            //}
        }
        ...
        private void SaveBTN_Click(object sender, EventArgs e)
        {
            ...
            {
                peopleList.Add(new People(NameTB.Text, Convert.ToInt32(BalanceTB.Text)));
                NameTB.Text = "";
                BalanceTB.Text = "";
